...
part of : BITSS Bergen August 2017 Workshop
time : 3 hours
author: Eva Vivalt
...
Draws substantially from [Garret Christensen](https://github.com/BITSS/NewDelhi2017)'s great materials from BITSS Delhi 2017, who in term thanks [Dillon Niederhut](https://github.com/deniederhut/BITSS2016) and [Justin Kitzes](https://bids.github.io/2017-01-12-ucb/lessons/git/) for some original materials.
...
Luckily for us, GitHub has built a GUI that makes working with `git` easier, although at some power cost. Actually, several GUIs are available, with different pros and cons - some popular ones are SourceTree or GitKraken. Many experienced users use the command line (Terminal on a Mac, Git Shell or Git Bash on Windows) to run Git, but GitHub Desktop can do some of the simpler tasks. You can also use GitHub through their web interface.

You may find you have to use the command line to do something. If that's scary, help is [here](http://swcarpentry.github.io/shell-novice/02-filedir/), or don't be afraid to ask.
...
* Download and install the [GitHub Desktop app](http://desktop.github.com) (if desired; you can also use an alternative GUI, though these won't be covered during this workshop, or use command line tools).
...
* Navigate to [github.com/vivalt/Bergen2017](github.com/vivalt/Bergen2017)
...
You can also add, create, or clone a repository. *Adding* is finding and telling the app that a repository is already on your computer. *Creating* creates a new repository. *Cloning* is copying an existing repository from your GitHub account.
